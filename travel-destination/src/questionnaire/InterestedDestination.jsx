...
return (
  <div>
   ...
   <button className="flex items-center gap-2 bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600" onClick={() => navigate("/Review")}><Pencil size={18} /> Reviews</button>
